...
export default {
  ...
  taskStations: [
    ...
    { id: 'ts_irr_pump', pos: [-25, 0, -11.4], rot: 0, minigame: 'coolantPurge', label: 'Pump' },
    ...
    { id: 'ts_shed_wire', pos: [6.4, 0, 20], rot: -H, minigame: 'wireSplice', label: 'Lights' },
    { id: 'ts_maze_sprinkler', pos: [42.4, 0, 10], rot: -H, minigame: 'coolantPurge', label: 'Sprinkler' },
